---
title: EuroSciPy 2025 - Sponsoring
url: 2025/sponsoring.html
save_as: 2025/sponsoring.html
...
|           |                                                                                   |
|-----------|-----------------------------------------------------------------------------------|
| July 15 | Deadline for Diamond and Platinum sponsoring                                      |
| August 01 | Deadline for all sponsoring packages                                              |
...
> EuroSciPy 2025, held in Kraków, Poland, will feature two days of tutorials,
...
<table style="table-layout:fixed">
    <tr>
        <td style="width: 25%;">
            <img src="../static/2025/sponsors/levels/diamond.jpg">
        </td>
        <td style="width: 75%;">
    ...
    <tr style="background: none;">
        <td style="width: 25%;">
            <img src="../static/2025/sponsors/levels/platinum.jpg">
        </td>
        <td style="width: 75%;">
    ...
    <tr>
        <td style="width: 25%;">
            <img src="../static/2025/sponsors/levels/maintainers.jpg">
        </td>
        <td style="width: 75%;">
    ...
    <div class="tg-packages">
        ...
        <div class="tg-package">
            <div class="tg-packagehead">
                ...
                <img src="../static/2025/sponsors/levels/bronze.jpg" style="width: 80px;"/>
            </div>
            <span class="tg-price">
                <sup>750€ + VAT</sup>
            </span>
        ...
        <div class="tg-package">
            <div class="tg-packagehead">
                <img src="../static/2025/sponsors/levels/silver.jpg" style="width: 80px;"/>
            </div>
            <span class="tg-price">
                <sup>1200€ + VAT</sup>
            </span>
            ...
            <div class="tg-package">
                <div class="tg-packagehead">
                    ...
                    <img src="../static/2025/sponsors/levels/gold.jpg" style="width: 80px;"/>
                </div>
                <span class="tg-price">
                    <sup>2000€ + VAT</sup>
                </span>
